...
export const handler: Handler = async (event: HandlerEvent): Promise<ResponseInterface> => {
	try {
		...
		const message: MailDataRequired = {
			...
			subject: `${name} - Resume`,
			html: `<p>Hi yahooo${to},</p><p>Please find my resume attached.</p><p>Best regards,<br>${name}.</p><p>This email was automatically generated by Aashay Thakur's Portfolio. You can still reply to this email for further communication.</p>`,
			attachments: [
				{
